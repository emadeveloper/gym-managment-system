...
@Entity
@Table(name = "user_assigned_routine_exercises")
@Getter
@Setter
@NoArgsConstructor
public class UserAssignedRoutineExerciseJpaEntity {

    @Id
    private UUID id;

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "user_assigned_routine_day_id", nullable = false)
    private UserAssignedRoutineDayJpaEntity userAssignedRoutineDay;
